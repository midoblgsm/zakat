        ...
        <ul className="space-y-1">
          {navItems.map((item) => (
            <li key={item.path}>
              <NavLink
                to={item.path}
                end={item.path === '/applicant' || item.path === '/admin' || item.path === '/super-admin'}
                className={({ isActive }) =>
                  clsx(
